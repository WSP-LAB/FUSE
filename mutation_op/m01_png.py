...
class mOP(MutationOP):
  __comment__ = "Mutation1 : set 1024byte from png resource file in front of seed"
  ...
  __resource__ =  {"png":"resource/test.png"} # ({type:resource filename})
