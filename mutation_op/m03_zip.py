...
class mOP(MutationOP):
  ...
  __exclusion_op__ = {'php':['M03_GIF', 'M03_JPG', 'M03_PDF', 'M03_PNG', 'M03_TAR_GZ', 'M03_ZIP'], 'html':['M03_GIF', 'M03_JPG', 'M03_PDF', 'M03_PNG', 'M03_TAR_GZ', 'M03_ZIP', 'M04_BZ2', 'M04_XHT'], 'xhtml':['M03_GIF', 'M03_JPG', 'M03_PDF', 'M03_PNG', 'M03_TAR_GZ', 'M03_ZIP', 'M04_BZ2'], 'js':['M03_GIF', 'M03_JPG', 'M03_PDF', 'M03_PNG', 'M03_TAR_GZ', 'M03_ZIP', 'M04_JPG', 'M04_PNG', 'M04_GIF']}#['M03_JPG', 'M03_PNG', 'M03_GIF', 'M03_TAR_GZ', 'M03_PDF'] # ([classname])when this op used for mutation,
                        # operations in this list can be used to extra mutation.
  __resource__ = {"zip":"resource/test.zip"} # ({type:resource filename})
